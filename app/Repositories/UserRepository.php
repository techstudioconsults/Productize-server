...
class UserRepository extends Repository
{
     ...
     * @param string|null $start_date The start date of the date range to filter orders (optional).
     * @param string|null $end_date The end date of the date range to filter orders (optional).
     *
     ...
     *
     * @param string|null $start_date The start date of the date range to filter customers (optional).
     * @param string|null $end_date The end date of the date range to filter customers (optional).
     *
