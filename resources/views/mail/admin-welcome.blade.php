<x-mail::message>
    ...
    <h1>Welcome to the Bytealley Admin Team!</h1>
    <p>We are excited to inform you that you have been added as an admin on Bytealley. Below are your login details:</p>
